...
function page_apply()
{
	url = "${base}/party/partydue/research/baseapprove/apply.action?runactkey=${obj.runactkey}";	 
	window.location = url;
}
...
function page_edit()
{
	url = "${base}/party/partydue/research/baseapprove/locate.action?runactkey=${obj.runactkey}";	 
	window.location = url;
}
