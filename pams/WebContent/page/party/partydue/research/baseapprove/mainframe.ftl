  ...
  <body>
    <div id="gsLayoutContainer">
      ...
      <div id="leftNavi">
        ...
        <ul class="sub">
        <li><a href="${base}/party/partydue/research/baseapprove/browseplan.action">待执行任务</a></li>
        ...
        <li class="active"> 
            ...
            <ul class="sub">
              ...
              <li class="active"> <a href="${base}/party/partydue/research/baseapprove/browsewait.action">个人待办业务</a></li>
              <li><a href="${base}/party/partydue/research/baseapprove/browsehandle.action">个人已办业务</a></li>
              <li><a href="${base}/party/partydue/research/baseapprove/browseall.action">个人全部业务</a></li>
            </ul>
          </li>
          <li> 
      ...
      <div id="gsLayoutContainer-right">
        <iframe src="${base}/party/partydue/research/baseapprove/browsewait.action" frameborder="0" name="rightFrame" allowtransparency="true"></iframe>
      </div>
    </div>
